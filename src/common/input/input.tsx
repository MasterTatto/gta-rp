...
const Input = ({
    ...
    return (
        <div className={`${s.input} ${className}`}>
            ...
            <input pattern={pattern} required={required} type={type} placeholder={placeholder} value={value}
            ...
            />
            {securityPassword && <div className={s.scaleSecurity}>
